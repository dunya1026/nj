...
const summerEvents = [
  ...
  { date:"7월 10일", place:"치앙마이 방콕", area:"대전광역시", coords:[36.3504,127.3845], note:"대숲 사이를 걷고 이국적인 음식을 나눴던 날. 대전에 있으면서도 잠시 여행을 온 것 같았어.", photos:["03-v2","04"] },
  ...
  { date:"7월 24일", place:"용강동 → 마포 한강", area:"서울 · 마포구", coords:[37.5411,126.9387], note:"마주 앉아 저녁을 먹고 한강의 불빛과 둥근 달을 함께 바라본 밤. 하루의 끝까지 작은 기념일 같았어.", photos:["11-v2","12"] },
